...
#dump_path = r'/home/ricky/kaggle_diabetic_retinopathy-master/kaggle_diabetic_retinopathy-master/dumps/2015_07_17_123003.pkl'
...
if os.path.exists('/media/ricky/'):
    prefix_path = '/media/ricky/Data/Data'
else:
    prefix_path = '/run/shm/'
...
if sys.argv[2] == 'all_train':
    ...
    img_dir = prefix_path + 'train/'
elif sys.argv[2] == 'test':
    # Test.
    dataset = 'test'
    img_dir = prefix_path + 'test/'
