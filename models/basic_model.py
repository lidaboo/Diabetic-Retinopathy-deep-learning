...
prefix_train = '/media/ricky/Data/Data/train/'
prefix_test = '/media/ricky/Data/Data/test/'
...
id_train, y_train, id_valid, y_valid = split_data(train_labels, labels_split,valid_size=10,SEED=SEED, pairs=True)
